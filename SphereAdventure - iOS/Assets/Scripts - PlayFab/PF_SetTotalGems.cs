...
public class PF_SetTotalGems : MonoBehaviour {


	public float CoinsFromPlayerPrefs;
	public int convertedCoins;
	
	// Use this for initialization
	void Start () {
		
	CoinsFromPlayerPrefs = PlayerPrefs.GetFloat("Gems");
	convertedCoins = Mathf.FloorToInt(CoinsFromPlayerPrefs);
    ...
    Statistics = new List<StatisticUpdate> {
        new StatisticUpdate { StatisticName = "Coins", Value = convertedCoins },
    }
},
result1 => { Debug.Log("Gems saved"); },
